		...
		<section
			...
			<div className='max-w-[1240px]'>
				<div className='grid gap-4 xs:grid-cols-2 md:grid-cols-4 '>
					...
					<div className='hidden h-10 text-2xl font-bold rounded md:text-3xl bg-accent xs:h-auto xs:square xs:grid place-items-center'>
						SARS
					</div>
					<div className='hidden h-10 text-2xl font-bold rounded md:text-3xl bg-primary xs:h-auto xs:square xs:grid place-items-center'>
						CIPC
					</div>
					<div className='hidden h-10 text-2xl font-bold rounded md:text-3xl bg-secondary xs:h-auto xs:square xs:grid place-items-center'>
						Accounting
					</div>
					<div className='hidden h-10 text-2xl font-bold bg-blue-500 rounded md:text-3xl xs:h-auto xs:square xs:grid place-items-center'>
						CIDB
					</div>
					<div className='hidden h-10 text-2xl font-bold bg-green-500 rounded md:text-3xl xs:h-auto xs:square xs:grid place-items-center '>
						COID
					</div>
					...
					<div className='hidden h-10 text-2xl font-bold bg-gray-500 rounded md:text-3xl xs:h-auto xs:square xs:grid place-items-center'>
						CSD
					</div>
					<div className='h-10 row-start-7 p-2 text-2xl font-bold bg-pink-500 rounded xs:row-start-6 md:row-start-4 md:col-start-4 md:text-3xl xs:h-auto xs:square xs:grid place-items-center'>
						We Got Your Back
					</div>
